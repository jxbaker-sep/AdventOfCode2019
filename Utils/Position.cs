...
public class Position
{
    ...
    public bool IsOrthoganallyAdjacent(Position other)
    {
        return other != this && ManhattanDistance(other) <= 1;
    }
    ...
    {
        return OrthoganallyOrDiagonallyAdjacent(other) && !IsOrthoganallyAdjacent(other);
    }
